...
UDaisyAbilitySystemComponent* UPlayMontageAndWaitForEvent::GetTargetASC()
{
	return Cast<UDaisyAbilitySystemComponent>(AbilitySystemComponent);
}
...
void UPlayMontageAndWaitForEvent::Activate()
{
	...
	UDaisyAbilitySystemComponent* RPGAbilitySystemComponent = GetTargetASC();
